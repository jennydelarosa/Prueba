            ...
            steps {
                script{
                    sh ''' 
                        ...
                        docker tag python-flask:0.0.1 897616845305.dkr.ecr.us-east-1.amazonaws.com/helloword:0.0.1

                        docker push 897616845305.dkr.ecr.us-east-1.amazonaws.com/helloword:0.0.1
